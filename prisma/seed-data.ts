...
export const CREATORS: SeedCreator[] = [
  {
    ...
    instructorBio:
      "გიორგი 12 წელია მუშაობს ციფრულ მარკეტინგში და ხელმძღვანელობდა კამპანიებს საქართველოს წამყვანი ბრენდებისთვის. მისი გაკვეთილები აგებულია რეალურ ქეისებზე — არა თეორიაზე. დღემდე გადაამზადა 3000-ზე მეტი სპეციალისტი.",
    city: "თბილისი",
  ...
  },
  {
    ...
    instructorBio:
      "ნინო Senior Python დეველოპერია საერთაშორისო პროდუქტულ კომპანიაში. ის ასწავლის პროგრამირებას ნულიდან — ისე, როგორც თავად უნდოდა რომ ესწავლა დაწყებისას. ყველა გაკვეთილი შეიცავს პრაქტიკულ პროექტებს.",
    city: "თბილისი",
  ...
  },
  {
    ...
    instructorBio:
      "ლევანმა 2015 წლიდან სამი კომპანია დააფუძნა საქართველოში — ორი წარმატებული, ერთი წარუმატებელი. სწორედ ამიტომ მისი გაკვეთილები საუბრობს არა მხოლოდ წარმატებაზე, არამედ იმ შეცდომებზეც, რომლებიც ძვირი დაუჯდა.",
    city: "ბათუმი",
  ...
  },
  {
    ...
    instructorBio:
      "ანა AI პროდუქტ-მენეჯერია და ეხმარება ქართულ კომპანიებს ხელოვნური ინტელექტის ინსტრუმენტების დანერგვაში. მისი გაკვეთილები ორიენტირებულია პრაქტიკულ შედეგზე, არა ჰაიპზე.",
    city: "თბილისი",
  ...
  },
  {
    ...
    instructorBio:
      "მარიამი 200-საათიანი სერტიფიცირებული იოგას ინსტრუქტორია და ბათუმში საკუთარ სტუდიას უძღვება. მისი გაკვეთილები დამწყებზეა გათვლილი — მათზე, ვისაც ჰგონია, რომ „საკმარისად მოქნილი არ ვარ იოგისთვის\".",
    city: "ბათუმი",
...
const standardFaqs = [
  {
    question: "რამდენ ხანში მაქვს გაკვეთილზე წვდომა?",
    answer: "წვდომა სამუდამოა. ერთხელ შეძენის შემდეგ გაკვეთილი და მისი ყველა მომავალი განახლება თქვენია.",
  },
  {
  ...
  },
  {
    ...
    answer: "დიახ. გაკვეთილის 100%-ით დასრულების შემდეგ ავტომატურად გენერირდება სერტიფიკატი უნიკალური ID-ით, რომლის დამოწმებაც ნებისმიერს შეუძლია.",
  },
];
...
export const COURSES: SeedCourse[] = [
  {
    ...
    description:
      "ეს გაკვეთილი შექმნილია მათთვის, ვისაც სურს ციფრული მარკეტინგის სისტემური გაგება. თეორიის ნაცვლად ვმუშაობთ რეალურ ქეისებზე: ბრენდის პოზიციონირებიდან Facebook და Google რეკლამის გაშვებამდე, ანალიტიკის დაყენებიდან შედეგების გაზომვამდე.\n\nგაკვეთილის ბოლოს გექნებათ დასრულებული მარკეტინგული სტრატეგია და გაშვებული პირველი კამპანია.",
    ...
    modules: [
      {
        ...
        lessons: [
          { title: "გაკვეთილის მიმოხილვა", type: "VIDEO", durationSeconds: 12, isFreePreview: true,
            description: "რას ისწავლით ამ გაკვეთილში და როგორ გამოიყენოთ მასალა მაქსიმალურად." },
  ...
  },
  {
    ...
    description:
      "Python ყველაზე მოთხოვნადი ენაა დამწყებთათვის და არა შემთხვევით: მისი სინტაქსი ინგლისურ ენას ჰგავს და კოდის დაწერა სწრაფად ისწავლება.\n\nამ გაკვეთილში ვიწყებთ ცვლადებიდან და მივდივართ რეალურ პროექტებამდე — ვქმნით კალკულატორს, ვამუშავებთ ფაილებს, ვწერთ ვებ-სკრეიპერს და ვაშენებთ პატარა API-ს.",
  ...
  },
  {
    ...
    description:
      "ბიზნესის დაწყება საქართველოში უფრო მარტივია, ვიდრე ბევრი ფიქრობს — მაგრამ მხოლოდ მაშინ, თუ იცი თანმიმდევრობა.\n\nეს გაკვეთილი გატარებთ მთელ გზაზე: იდეის ვალიდაციიდან ინდივიდუალური მეწარმის რეგისტრაციამდე, გადასახადების რეჟიმის არჩევიდან პირველი კლიენტის მოზიდვამდე.",
  ...
  },
  {
    ...
    description:
      "ხელოვნური ინტელექტი აღარ არის მომავლის თემა — ის უკვე ამცირებს ხარჯებს იმ კომპანიებში, რომლებმაც სწორად დანერგეს.\n\nეს გაკვეთილი არ არის ჰაიპზე. ვმუშაობთ კონკრეტულ ამოცანებზე: ტექსტის მომზადება, მონაცემების დამუშავება, კლიენტის მომსახურება, დოკუმენტების ანალიზი და სამუშაო პროცესების ავტომატიზაცია.",
  ...
  },
  {
    ...
    description:
      "ფინანსური წიგნიერება არ საჭიროებს ეკონომიკურ განათლებას. საჭიროა სისტემა და თანმიმდევრობა.\n\nგაკვეთილი გასწავლით ბიუჯეტის შედგენას, ვალის სწორ მართვას, სარეზერვო ფონდის შექმნას და ინვესტირების საფუძვლებს — ქართული რეალობის გათვალისწინებით.",
  ...
  },
  {
    ...
    subtitle: "კვლევიდან პროტოტიპამდე — სრული პროცესი ერთ გაკვეთილში",
    description:
      "კარგი დიზაინი ლამაზი ეკრანი არ არის — ეს გადაწყვეტილებების თანმიმდევრობაა.\n\nგაკვეთილში გავივლით სრულ პროცესს: მომხმარებლის კვლევა, ინფორმაციული არქიტექტურა, wireframe, ვიზუალური დიზაინი, დიზაინ-სისტემა და ინტერაქტიული პროტოტიპი.",
  ...
  },
  {
    ...
    description:
      "B2B გაყიდვა გრძელი პროცესია, სადაც გადაწყვეტილებას რამდენიმე ადამიანი იღებს.\n\nგაკვეთილი გასწავლით სისტემურ მიდგომას: ლიდების კვალიფიკაცია, პირველი შეხვედრა, საჭიროების გამოვლენა, შეთავაზების მომზადება, წინააღმდეგობებთან მუშაობა და გარიგების დახურვა.",
  ...
  },
  {
    ...
    subtitle: "პროფესიონალური კადრები ტელეფონით — უფასო გაკვეთილი",
    description:
      "საუკეთესო კამერა ის არის, რომელიც თან გაქვს.\n\nეს უფასო გაკვეთილი გასწავლით კომპოზიციას, შუქთან მუშაობას და დამუშავებას — ყველაფერს, რაც ტელეფონის კამერით შედეგს გააუმჯობესებს.",
  ...
  },
  {
    ...
    description:
      "პროდუქტიულობა დისციპლინაზე მეტად სისტემაზეა დამოკიდებული.\n\nგაკვეთილში ავაწყობთ პირად სისტემას: ამოცანების შეგროვება, პრიორიტეტიზაცია, კალენდრის დაგეგმვა და ყურადღების დაცვა.",
    creatorEmail: "ana.maisuradze@example.ge",
  ...
  // ── Wellness & creator-economy catalogue ─────────────────────────────────
  {
    ...
    description:
      "დარბაზში მისული ადამიანების უმეტესობა არასწორად ვარჯიშობს — არა იმიტომ, რომ ზარმაცია, არამედ იმიტომ, რომ არავის უჩვენებია, როგორ უნდა. ეს გაკვეთილი სწორედ ამას ასწორებს.\n\nვიწყებთ ხუთი ძირითადი მოძრაობის ტექნიკით — ბერკეტი, სკვატი, ვერტიკალური და ჰორიზონტალური წევა, ბიძგი — შემდეგ ვსწავლობთ, როგორ ავაწყოთ პროგრამა შენი დღეების, სტაჟისა და მიზნის მიხედვით.\n\nგაკვეთილის ბოლოს გექნება საკუთარი, დაწერილი პროგრამა და ის ცოდნა, რომელიც საშუალებას მოგცემს, ის თავად შეცვალო.",
    ...
    modules: [
      {
        ...
        lessons: [
          { title: "როგორ ვისწავლოთ ამ გაკვეთილით", type: "VIDEO", durationSeconds: 14, isFreePreview: true,
            description: "გაკვეთილის სტრუქტურა და როგორ გამოიყენო ვიდეოები დარბაზში." },
      ...
      },
      {
        ...
        lessons: [
          ...
          { title: "პრაქტიკული დავალება — შენი პირველი 8-კვირიანი გეგმა", type: "TEXT",
            description: "დაწერე საკუთარი პროგრამა გაკვეთილში ნასწავლი წესებით.",
            textContent:
  ...
  },
  {
    ...
    description:
      "დიეტების უმეტესობა მუშაობს — სამი კვირა. შემდეგ ცხოვრება ბრუნდება და ყველაფერი უკან მიდის. ეს გაკვეთილი საპირისპიროზეა აგებული: ვსწავლობთ პრინციპებს, რომლებიც შენს ცხოვრებას ერგება, არა პირიქით.\n\nგავივლით ენერგეტიკულ ბალანსს, ცილას, პორციის შეფასებას თვალით, სასურსათო მაღაზიაში არჩევანს და იმას, რა უნდა გააკეთო, როცა გეგმა ირღვევა — რადგან აუცილებლად დაირღვევა.",
  ...
  },
  {
    ...
    description:
      "ალგორითმი შენი მტერი არ არის. ის უბრალოდ ზომავს, ადამიანი ბოლომდე უყურებს თუ არა შენს ვიდეოს — და თითქმის ყველაფერი, რაც მნიშვნელოვანია, პირველ სამ წამში ხდება.\n\nამ გაკვეთილში ვშლით მოკლე ვიდეოს ნაწილებად: კაუჭი, სტრუქტურა, ტემპი, ტიტრები და ბოლო კადრი. ვმუშაობთ რეალურ მაგალითებზე — ჩემს ვიდეოებზე, რომლებმაც იმუშავა, და იმაზეც, რომლებმაც არა.",
      ...
      },
      {
        ...
        lessons: [
          ...
          { title: "პრაქტიკული დავალება — შენი პირველი 10 ვიდეო", type: "TEXT",
            description: "დაგეგმე 10 ვიდეო გაკვეთილის შაბლონით.",
            textContent:
  ...
  },
  {
    ...
    description:
      "მიმდევრების რაოდენობა შემოსავალი არ არის. ვიცნობ 8000-მიმდევრიან კრეატორს, რომელიც კარგად ცხოვრობს კონტენტით, და 300 000-იანს, რომელსაც არაფერი შემოსდის.\n\nეს გაკვეთილი მონეტიზაციის ხუთ რეალურ გზას შლის: ციფრული პროდუქტი, ონლაინ გაკვეთილი, გამოწერა, სპონსორობა და მომსახურება. თითოეულზე ვსაუბრობთ კონკრეტულად — რა ფასი, რა მოცულობის აუდიტორია სჭირდება, რა კონვერსიაა რეალისტური და როგორ მუშაობს ეს საქართველოში, ქართული გადახდებით.",
    creatorEmail: "saba.lominadze@example.ge",
...
export const REVIEW_TEXTS = [
  ...
  { rating: 5, title: "ღირს ყოველი თეთრი", body: "ვნახე რამდენიმე უფასო გაკვეთილი იუთუბზე, მაგრამ სისტემურობა აკლდა. აქ თანმიმდევრობაა და ეს მთავარია." },
  { rating: 4, title: "კარგი გაკვეთილია", body: "ძალიან კარგი შინაარსი. ზოგიერთი ვიდეო ცოტა გრძელია, მაგრამ ინფორმაცია ღირებულია." },
  ...
  { rating: 5, title: "საუკეთესო ქართულ ენაზე", body: "ბოლოს იპოვე ნორმალური გაკვეთილი ქართულად. აღარ მიწევს ინგლისურ მასალაზე ბრძოლა." },
  ...
  { rating: 4, title: "ღირებული გამოცდილება", body: "სერტიფიკატიც მივიღე და CV-ში დავამატე. გაკვეთილებმა ნამდვილად მომცა თავდაჯერებულობა." },
